 ...
 *
 * Using simple numbers allows us to generate 28.6 million unique ids per second for 10 years.js before
  ...
  <example module="ngAnimate" deps="angular-animate.js" animations="true">
      ...
      <div ng-init="friends = [
        ...
        <ul class="example-animate-container">
          <li class="animate-repeat" ng-repeat="friend in friends | filter:q as results">
            [{{$index + 1}}] {{friend.name}} who is {{friend.age}} years.js old.
          </li>
    ...
    <file name="protractor.js" type="protractor">
      ...
      it('should render initial data set', function() {
        ...
        expect(friends.get(0).getText()).toEqual('[1] John who is 25 years.js old.');
        expect(friends.get(1).getText()).toEqual('[2] Jessie who is 30 years.js old.');
        expect(friends.last().getText()).toEqual('[10] Samantha who is 60 years.js old.');
       ...
       it('should update repeater when filter predicate changes', function() {
         ...
         expect(friends.get(0).getText()).toEqual('[1] Mary who is 28 years.js old.');
         expect(friends.last().getText()).toEqual('[2] Samantha who is 60 years.js old.');
       });
      </file>
    </example>
 */
